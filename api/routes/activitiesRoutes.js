      ...
      for (let j = 0; j < activities.length; j++) {
        for (let k = 0; k < plants.length; k++) {
          ...
          if (
            ...
            object = {
              land_name: lands.data[i].name,
              land_id: lands.data[i].land_id,
    ...
    function(err, docs) {
      ...
      if (err) {
        ...
        if (docs.length == 0) {
          ...
          if (docs[0].activities.manager_id != null || docs[0].activities.manager_id != undefined) {
